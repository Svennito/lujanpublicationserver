...
`			
				...
				<li class="fieldcontain">
					...
					<span id="url-label" class="property-label"><g:message code="bibtab.url.label" default="Document URL" /></span>
					<span class="property-value" aria-labelledby="url-label"><a href="${fieldValue(bean: bibtabInstance, field: "url")}" target="_blank" >${fieldValue(bean: bibtabInstance, field: "url")}</a></span>

					<span id="citelinks-label" class="property-label"><g:message code="bibtab.citelinks-label.label" default="Citations URL" /></span>
					<span class="property-value" aria-labelledby="citelinks-label"><a href="${fieldValue(bean: bibtabInstance, field: "citelinks")}" target="_blank" >${fieldValue(bean: bibtabInstance, field: "citelinks")}</a></span>
				</li>
				</g:if>
