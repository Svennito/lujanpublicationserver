...
<!--[if (gt IE 9)|!(IE)]><!--> <html lang="en" class="no-js"><!--<![endif]-->
	...
	<body>
		...
		<g:layoutBody/>
		<div class="footer" role="contentinfo">&copy; 2012,2013 Sven Vogel, LANSCE-LC. For problems, questions, ideas, etc. please send email to <a href="mailto:sven@lanl.gov?Subject=Publication%20Database">sven@lanl.gov</a></div>
